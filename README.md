...
这个问题在国内外游戏社区都还没有定论——"真正的AI原生应该发生在规则层"，或者"现在大多数AI游戏本质上只是AI增强"。*.memory* 站在这条边界上，我想用做出这个具体作品来作为我的回答。

#### 关于让 agent 扮演 agent 本身

我所见的大部分AI游戏都在让agent扮演某个角色、某种智慧生物或规则主持人。短暂的舞台表演经历和戏剧理论学习让我想到另一个问题：为什么不先让agent扮演agent本身？认清一个表演者的本质差异，或许比寻找共同点更能做好"扮演"这件事。这个方向还有很多值得探索的地方，在我制作过程中潜移默化。

#### 关于做一个失败的 agent

每次聊到AI，大家总是要求它有用、设计合理、有明确目标。于是我开始想，一个失败的、糟糕的agent会是什么样？

记得有句台词，不知出自哪部作品——"生活应该有一些毫无意义的东西，如果全是有意义的东西的话会窒息的"。这句话给了我一种表达形式的灵感。

海默2000、Type:Help 这类"捡到陌生设备、通过破解内容反推前使用者故事"的设计，也让我受益很深。有人说，AI agent 是一种新的操作系统——当大家像熟悉手机、电脑一样熟悉agent架构之后，是不是自然就会有类似的游戏出现？

半吊子的agent知识，半吊子的游戏编剧，于是就做出来了这样一个东西。
